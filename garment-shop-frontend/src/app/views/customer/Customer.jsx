                        ...
                        onClick={() => {
                          ...
                          if(name && email && address && phone){
                              ...
                              if (emailRegex.test(email)) {
                                      ...
                                      const res = axios.post(base_url + "Customer/create", {
                                        ...
                                        getCustomer()
                                          ...
                                          toast.error('Customer Fail to Create'); // Show error message
                                      });                         
                        ...
                        onClick={() => {
                          ...
                          if(name && email && address && phone){
                              ...
                              if (emailRegex.test(email)) {
                                      ...
                                      const res = axios.post(base_url + "Customer/update", {
                                        "id":id,
                                        "name":name,
                                        "email":email,
                                        "address":address,
                                        ...
                                        getCustomer()
                                          ...
                                          toast.error('Customer Fail to Update'); // Show error message
                                      });                         
                          ...
                          <Grid item>
                            <Typography sx={{ cursor: 'pointer' }} variant="body2">
                              ...
                              <Button
                                variant="outlined"
                                onClick={() => {
                                  const res = axios.post(base_url + "customer/delete", {id:child.id}).then((response) => {
                                    ...
                                    if (error.response) {
                                      ...
                                      toast.error('Unable to delete. This customer have orders'); // Show error message
                                    }
                                  });   
                                 }
                                }
